...
const auth = (...userRoles) => {
    return (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (!isUserExist) {
            throw new AppError_1.default(http_status_1.default.UNAUTHORIZED, 'Invalid user access');
        }
        if (isUserExist.status === 'blocked') {
            throw new AppError_1.default(http_status_1.default.UNAUTHORIZED, 'You are blocked from admin');
        }
