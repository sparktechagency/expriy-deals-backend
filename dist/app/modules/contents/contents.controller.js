...
// Get contents by ID
const getContentByQuery = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield contents_service_1.contentsService.getContentByQuery(req.query);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
        message: 'Content retrieved successfully',
